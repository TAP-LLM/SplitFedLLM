...
import re
#自由分割模型
sys.path.append('/home/zhangzishuai/SplitFederated-LLaMA/Models/central_model/')
from Inference.modeling_llama_official import LlamaForCausalLM

log_path = "/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/lora_splitmodel.log"
...
SplitA, SplitB, SplitC = False, False, False
LoraA, LoraB, LoraC = True, True, True
...
model.save_pretrained("/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/lora_r8_alpha16_weights/", save_only_lora=True,safe_serialization=False,map_location="cuda:1")

lora_weights_full = torch.load(f'/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/lora_r8_alpha16_weights/adapter_model.bin', map_location="cuda:1")
...
# 使用示例（假设总共有5层）
split_config = {
    'A': {'layers': list(range(0, 5)), 'save_path':'/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/lora_r8_alpha16_weights/lora_A'},
    'B': {'layers': list(range(1, 31)), 'save_path':'/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/lora_r8_alpha16_weights/lora_B'},
    'C': {'layers': list(range(27, 32)), 'save_path':'/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/lora_r8_alpha16_weights/lora_C'}
}
split_lora_weights("/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/lora_r8_alpha16_weights", split_config)
...
if SplitA:
    ...
    # 保存模型到不同的文件
    torch.save(modelA.state_dict(), '/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/clientA/pytorch_model_A.bin')
...
if SplitB:
    ...
    # 保存模型到不同的文件
    torch.save(modelB.state_dict(), '/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/server/pytorch_model_B.bin')

if SplitC:
    # 拆分模型为modelC
    modelC = torch.nn.Sequential(model.model.layers[27:], model.model.norm, model.lm_head)  # 第27,28,29,30,31层都保存，加载的时候不一定全部加载
    # 保存模型到不同的文件
    torch.save(modelC.state_dict(), '/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/clientC/new_pytorch_model_C.bin')
...
if SplitA:
    state_dict_A = torch.load('/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/clientA/pytorch_model_A.bin')
    state_dict_A = rename_keys_A(state_dict_A)
    torch.save(state_dict_A, '/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/clientA/modified_pytorch_model_A.bin')


if SplitB:
    state_dict_B = torch.load('/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/server/pytorch_model_B.bin')
    state_dict_B = rename_keys_B(state_dict_B)
    torch.save(state_dict_B, '/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/server/modified_pytorch_model_B.bin')

if SplitC:
    state_dict_C = torch.load('/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/clientC/new_pytorch_model_C.bin')
    state_dict_C = rename_keys_C(state_dict_C)
    torch.save(state_dict_C, '/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/clientC/modified_pytorch_model_C.bin')

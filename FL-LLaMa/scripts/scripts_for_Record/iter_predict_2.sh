...
# 定义版本路径
Version_dir="/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module/output/Record/version_3_r8_al32_Lr0.00003"
...
for CheckpointPath in $(ls -d ${Version_dir}/model-A/checkpoint-*); do
    ...
    Data_fold="/home/zhangzishuai/SplitFederated-LLaMA/Dataset/Record/"

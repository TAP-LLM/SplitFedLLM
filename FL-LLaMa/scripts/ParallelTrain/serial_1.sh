...
# ----------------- 超参数循环 -----------------
HYPERPARAMS_FILE="/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/batch_parallel_training/serial_1.txt"
...
while IFS= read -r line || [[ -n "$line" ]]; do
    ...
    #     rm "$LOG_FILE_5"
    # fi
    # LOG_FILE_6="$OUTPUT_DIR/trian_client_4_output.log"
    # # 检查日志文件是否存在，如果存在则删除
    # if [ -f "$LOG_FILE_6" ]; then
    #     rm "$LOG_FILE_6"
    # fi
    # LOG_FILE_7="$OUTPUT_DIR/trian_client_5_output.log"
    # # 检查日志文件是否存在，如果存在则删除
    # if [ -f "$LOG_FILE_7" ]; then
    #     rm "$LOG_FILE_7"
    # fi
    # LOG_FILE_8="$OUTPUT_DIR/trian_client_6_output.log"
    # # 检查日志文件是否存在，如果存在则删除
    # if [ -f "$LOG_FILE_8" ]; then
    #     rm "$LOG_FILE_8"
    # fi
    # LOG_FILE_9="$OUTPUT_DIR/trian_client_7_output.log"
    # # 检查日志文件是否存在，如果存在则删除
    # if [ -f "$LOG_FILE_9" ]; then
    #     rm "$LOG_FILE_9"
    # fi
    # LOG_FILE_10="$OUTPUT_DIR/trian_client_8_output.log"
    # # 检查日志文件是否存在，如果存在则删除
    # if [ -f "$LOG_FILE_10" ]; then
    #     rm "$LOG_FILE_10"
    # fi
    # LOG_FILE_11="$OUTPUT_DIR/trian_client_9_output.log"
    # # 检查日志文件是否存在，如果存在则删除
    # if [ -f "$LOG_FILE_11" ]; then
    #     rm "$LOG_FILE_11"
    # fi

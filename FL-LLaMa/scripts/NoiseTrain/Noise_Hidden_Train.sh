...
for Grad_noise_option in 0 0.02 0.05 0.1; do
    ...
    Device="cuda:0"
    #单个服务器上运行多个程序需要更改IP
    ServerIP="10.143.12.74:4050" 
    # GPU 0占用4050 6080  GPU 1占用8080 5040
    #400000
    Grad_noise=$Grad_noise_option
    DP_grad_norm_clip=0.04
    # GPU 4上已经占用8080 6080 4070 5040
    OUTPUT_DIR="/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module/output/NewDP_hidden/version_ModelA_layers{$ModelA_layers}_noise${Grad_noise_option}"
    ...
    nohup python /home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module/flserver_llama10.py \
        --do_train \
        --add_DP_hidden true \
        --device $Device \
        --server_ip $ServerIP \
    ...
    python /home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module/flclient_llama10_Client_0.py \
        --do_train \
        --add_DP_hidden true \
        --device $Device \
        --server_ip $ServerIP \

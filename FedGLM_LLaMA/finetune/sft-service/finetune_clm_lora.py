...
def main():
    ...
    if True:
        ...
        if data_args.train_files is not None:
            ...
            data_files["train"] = "/home/wanglingxiang/llama2_lora/打包/sft-service/train_test.csv"
            data_args.train_files = "/home/wanglingxiang/llama2_lora/打包/sft-service/train_test.csv"
            
        if data_args.validation_files is not None:
            data_files["validation"] = data_args.validation_files
        
        else:
            data_files["validation"] = "/home/wanglingxiang/llama2_lora/打包/sft-service/train_test.csv"
            data_args.validation_files = "/home/wanglingxiang/llama2_lora/打包/sft-service/train_test.csv"
        ...
        if not data_args.streaming:
            ...
            for split in ['train', 'validation']:
                ...
                for i in range(len(num_rows)):
                    input_ids_length = num_rows[i][0]
                    input_ids = [random.randint(100, 3200) for _ in range(input_ids_length)]
                    attention_mask = [1 for _ in range(input_ids_length)]
                    labels = input_ids[:]

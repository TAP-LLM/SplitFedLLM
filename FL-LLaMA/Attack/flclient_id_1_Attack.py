...
def FLparser(): 
    ...
    #                     help="The pretrained model checkpoint for lora weights.")
    parser.add_argument("--lora_modelA_path", type=str, default="/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/output/AttackExperiments/Version_0/client_0_model-A/checkpoint-8000")
    parser.add_argument("--lora_modelC_path", type=str, default="/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/output/AttackExperiments/Version_0/client_0_model-C/checkpoint-8000")
    ...
    parser.add_argument("--output_dir", type=str, help = 'output folder path', default="/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/output/BatchTrain")
...
def main(prompt: str =None , child_conn=None) -> None:
    ...
    if FL_args.do_train:
        ...
        if FL_args.custom_lora:
            ...
            Lora_A_state_dict = torch.load("/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/lora_r16_alpha32_weights/lora_A/adapter_model.bin")
            ...
            Lora_C_state_dict = torch.load("/home/zhangzishuai/SplitFederated-LLaMA/Fed-Llama-module-autosplit/lora_r16_alpha32_weights/lora_C/adapter_model.bin")
    ...
    if not FL_args.from_pickle:
        ...
        if FL_args.dataset_name == "Record":
            if FL_args.do_train:
                # 从中心化哪里来的数据
                stored_path = f"/home/zhangzishuai/SplitFederated-LLaMA/pickle-store/MultiRC_bs2_central_train_client1.pickle"

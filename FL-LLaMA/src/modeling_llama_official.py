...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        # embed positions
        hidden_states = inputs_embeds # 3.1281e-03, -1.7090e-02,  1.4038e-02
        ...
        for decoder_layer in self.layers:
            ...
            hidden_states = layer_outputs[0] #[[ 6.4850e-04, -7.6752e-03,  3.2043e-02
...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        hidden_states = outputs[0] #-0.4292,  0.6914,  2.0312,  ..., -0.2876,  4.1719
        if self.config.pretraining_tp > 1:
